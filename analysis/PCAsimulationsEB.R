...
#res <- foreach(i=1:100) %dopar% simandfitPCs.ind.eb(ntips, ntraits, a=a, sig2=1, trait.seq=trait.seq)
#save(res, file=paste("simseb", ntips, ntraits,".rds", sep="_"))
