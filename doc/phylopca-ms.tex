...
\mathbf{R} = (n-1)^{-1}(\mathbf{X} - \mathbf{1}\boldsymbol{\mu}) (\mathbf{X} - \mathbf{1}\boldsymbol{\mu})
\end{equation}
...
\mathbf{S}=(\mathbf{X} - \mathbf{1}\boldsymbol{\mu})\mathbf{V}
\end{equation}
...
\mathbf{1}^\intercal \mathbf{\Sigma}^{-1} \mathbf{X}]
\end{equation}
In pPCA, Equation \ref{eq:rpca} is therefore modified as
\begin{equation}\label{eq:rppca}
\mathbf{R} = (n-1)^{-1}(\mathbf{X} - \mathbf{1a})^\intercal \mathbf{\Sigma}^{-1} (\mathbf{X} - \mathbf{1a})
\end{equation}
...
\mathbf{S}=(\mathbf{X} - \mathbf{1a})\mathbf{V}
\end{equation}
